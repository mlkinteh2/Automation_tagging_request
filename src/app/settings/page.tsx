  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-5"><div className="flex items-center gap-3 mb-3"><ShieldCheck className="w-5 h-5 text-green-700" /><h2 className="font-bold text-slate-100">Access Control</h2></div><p className="text-xs text-slate-400">Access is limited to two configured users: Administrator and Field Operator.</p><span className="inline-flex mt-4 layout-status layout-status-installation">TWO USER ACCOUNTS</span></div>
      </div>
    </div>
  );
}
